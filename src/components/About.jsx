    ...
    return (
        <div className="about-container">
            <div className="about-header">
                <h1 className="about-title">About CryptoTracker</h1>
            </div>
            <div className="about-body">
                ...
                <div className="about-features">
                    <div className="about-feature">
                        <img src={placeholderImage} alt="Feature 1" className="about-feature-image" />
                    ...
                    <div className="about-feature">
                        <img src={placeholderImage} alt="Feature 2" className="about-feature-image" />
                    ...
                    <div className="about-feature">
                        <img src={placeholderImage} alt="Feature 3" className="about-feature-image" />
